...
class Product(models.Model):
    title = models.CharField(max_length=255, verbose_name="Наименование товаров")
    ...
    info = models.TextField(default="Дополнительная информация о продукта", verbose_name="Информация о товаре")
